...
import { escapeHtml, fmtGs, numeroALetras } from "@/lib/documentos/formato";
...
/** Acreedor del pagaré: la razón social legal, no el nombre comercial. */
const ACREEDOR = "GRUPO FERRE E.A.S.";
const ACREEDOR_RUC = "80173997-7";
...
<body>
  ...
  <div class="hoja">
    ...
    <div class="datos">
      ...
      <div><span class="lbl">Acreedor:</span> <strong>${escapeHtml(ACREEDOR)}</strong> — R.U.C. ${escapeHtml(ACREEDOR_RUC)}</div>
