-- ============================================================================
-- Estado de PAGO en compras (Ferrecolor). ADITIVA E IDEMPOTENTE.
...
ALTER TABLE ferrecolor.compras
...
COMMENT ON COLUMN ferrecolor.compras.estado_pago IS
...
COMMENT ON COLUMN ferrecolor.compras.pagada_at IS
  'Momento en que la compra se marco como pagada (NULL mientras esta pendiente).';
COMMENT ON COLUMN ferrecolor.compras.pago_caja_movimiento_id IS
